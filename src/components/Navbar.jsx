        ...
        <nav className='fixed z-50 w-full top-4 px-4'>
            ...
            <div className={`md:hidden transition-all duration-300 ease-in-out ${isMobileMenuOpen ? 'max-h-[400px] opacity-100 py-4' : 'max-h-0 opacity-0 overflow-hidden'} bg-white/30 backdrop-blur-lg rounded-lg mt-2 shadow-lg`}>
                <ul className='flex flex-col items-center gap-4 font-medium'>
                    <li>
                        <Link to='/' onClick={closeMenu} className='block w-full text-center py-1'>Home</Link>
                    </li>
                    <li>
                        <Link to='/about' onClick={closeMenu} className='block w-full text-center py-1'>About</Link>
                    </li>
                    <li>
                        <Link to='/services' onClick={closeMenu} className='block w-full text-center py-1'>Services</Link>
                    </li>
                    <li>
                        <Link to='/contact' onClick={closeMenu} className='block w-full text-center py-1'>Contact</Link>
                    </li>
                    <li>
                        <Link
                            to='/login'

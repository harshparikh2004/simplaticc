...
function Footer() {
  return (
    <div className='relative b-0 -z-10 w-full flex itemx-center justify-between px-16 py-8 bg-[#032224] rounded-t-[60px] md:rounded-t-[80px] mt-42'>
        ...
        <div className='flex flex-col gap-10 md:gap-0 md:flex-row items-center md:items-start md:justify-evenly px-16 py-8 mx-auto w-11/12 mt-22 mb-16'>
          <div className='text-white flex flex-col items-center justify-center md:items-start' style={{fontFamily:'Quicksand'}}>
            ...
            <ul className='flex flex-col gap-4 mt-8'>
              <li className='text-xl md:text-base font-medium cursor-pointer opacity-70 hover:opacity-100 transition-all duration-100 ease capitalize'><Link>Home</Link></li>
              <li className='text-xl md:text-base font-medium cursor-pointer opacity-70 hover:opacity-100 transition-all duration-100 ease capitalize'><Link>Home</Link></li>
              <li className='text-xl md:text-base font-medium cursor-pointer opacity-70 hover:opacity-100 transition-all duration-100 ease capitalize'><Link>Home</Link></li>
              <li className='text-xl md:text-base font-medium cursor-pointer opacity-70 hover:opacity-100 transition-all duration-100 ease capitalize'><Link>Home</Link></li>
            </ul>
          ...
          <div className='text-white flex flex-col items-center justify-center md:items-start' style={{fontFamily:'Quicksand'}}>
            ...
            <ul className='flex flex-col gap-4 mt-8'>
              <li className='text-xl md:text-base font-medium cursor-pointer opacity-70 hover:opacity-100 transition-all duration-100 ease capitalize'><a href='https://www.youtube.com' target="_blank">Home</a></li>
              <li className='text-xl md:text-base font-medium cursor-pointer opacity-70 hover:opacity-100 transition-all duration-100 ease capitalize'><a href='https://www.youtube.com' target="_blank">Home</a></li>
              <li className='text-xl md:text-base font-medium cursor-pointer opacity-70 hover:opacity-100 transition-all duration-100 ease capitalize'><a href='https://www.youtube.com' target="_blank">Home</a></li>
            </ul>
          </div>

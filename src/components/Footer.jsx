...
function Footer() {
  return (
    <div className='relative -z-10 w-full flex itemx-center justify-between px-16 py-8 bg-[#032224] rounded-t-[120px] mt-22'>
        ...
        <div className='absolute -z-[2] top-1/2 left-1/2 translate-x-1/3 -translate-y-1/2  w-[190px] h-[190px] rounded-full bg-[#ffffff] blur-[90px] '></div>
